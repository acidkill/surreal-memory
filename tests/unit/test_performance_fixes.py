...
try:
    from surreal_memory.engine.encoder import MemoryEncoder  # noqa: F401
...
try:
    from surreal_memory.storage.sqlite_versioning import _decompress_snapshot
...
try:
    from surreal_memory.mcp.server import handle_message
...
class TestEncoderPathways:
    ...
    def test_build_pathway_order(self):
        ...
        from surreal_memory.engine.pipeline_steps import _build_pathway
...
class TestMCPTimeout:
    ...
    async def test_timeout_returns_error(self):
        ...
        message = {
            ...
            "id": 1,
            "method": "tools/call",
            "params": {"name": "smem_remember", "arguments": {"content": "test"}},
        }

        # Use a very short timeout so the test completes quickly
        with patch("surreal_memory.mcp.server._TOOL_CALL_TIMEOUT", 0.5):
