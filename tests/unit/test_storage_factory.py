...
from surreal_memory.core.brain_mode import BrainMode, BrainModeConfig
...
class TestCreateStorage:
    ...
    async def test_local_mode_with_path(self, tmp_path: object) -> None:
        from surreal_memory.storage.factory import create_storage
    ...
    async def test_shared_mode_creates_shared_storage(self) -> None:
        from surreal_memory.core.brain_mode import SharedConfig
        from surreal_memory.storage.factory import create_storage
        ...
        with patch("surreal_memory.storage.factory.SharedStorage") as mock_cls:
    ...
    async def test_hybrid_mode_creates_hybrid_storage(self) -> None:
        from surreal_memory.core.brain_mode import HybridConfig
        from surreal_memory.storage.factory import create_storage
        ...
        with patch(
            "surreal_memory.storage.factory.HybridStorage.create",
...
class TestHybridStorage:
    ...
    def _make_hybrid(self, *, auto_sync: bool = True) -> tuple[object, AsyncMock, AsyncMock]:
        ...
        from surreal_memory.storage.factory import HybridStorage
    ...
    async def test_sync_merge(self) -> None:
        ...
        with patch(
            "surreal_memory.engine.merge.merge_snapshots",
...
class TestHybridStorageCreate:
    ...
    async def test_create_initializes_local(self, tmp_path: object) -> None:
        ...
        with patch("surreal_memory.storage.factory.SharedStorage"):
