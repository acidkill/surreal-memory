...
from surreal_memory.extraction.codebase import (
    CodeSymbolType,
    PythonExtractor,
    RegexExtractor,
    get_extractor,
)
from surreal_memory.git_context import GitContext, detect_git_context
...
class TestGitContext:
    ...
    def test_detect_git_context(self) -> None:
        ...
        # This test runs inside the Surreal-Memory repo itself
