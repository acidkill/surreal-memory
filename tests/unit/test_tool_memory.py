...
from surreal_memory.engine.tool_memory import (
    IngestResult,
    ProcessResult,
    _parse_buffer_line,
...
def _make_event(
    tool_name: str = "smem_recall",
    server_name: str = "surreal-memory",
    success: bool = True,
    duration_ms: int = 100,
...
class TestToolNeuronContent:
    def test_format(self) -> None:
        assert _tool_neuron_content("smem_recall") == "tool:smem_recall"
