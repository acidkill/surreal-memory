...
class RememberHandler:
    ...
    async def _remember(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        from surreal_memory.safety.sensitive import auto_redact_content, check_sensitive_content
        ...
        if raw_priority is not None:
            ...
            from surreal_memory.engine.importance import auto_importance_score
        ...
        try:
            ...
            _source = os.environ.get("SURREAL_MEMORY_SOURCE", "")[:256]
            ...
            try:
                ...
                stored_by_syn = Synapse.create(
                    ...
                    weight=1.0,
                    metadata={"actor": stored_by_actor, "tool": "smem_remember"},
                )
            ...
            if mem_type == MemoryType.DECISION:
                try:
                    from surreal_memory.engine.decision_intel import (
        ...
        try:
            from surreal_memory.engine.reflection import ReflectionEngine
        ...
        from surreal_memory.engine.quality_scorer import score_memory
