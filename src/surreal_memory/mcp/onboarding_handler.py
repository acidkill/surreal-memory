...
ONBOARDING_STEPS: tuple[OnboardingHint, ...] = (
    ...
    OnboardingHint(
        ...
        description="Let Surreal-Memory automatically detect and save decisions, errors, and TODOs from conversation text.",
    ...
    OnboardingHint(
        ...
        description=(
            "Run 'smem init' once to install the PreCompact hook in Claude Code. "
            ...
            "when smem_remember or smem_auto is called explicitly."
        ),
        example_tool="smem_auto",
...
class OnboardingHandler:
    ...
    async def _check_onboarding(self) -> dict[str, Any] | None:
        ...
        return {
            "onboarding": True,
            "message": "Welcome to Surreal-Memory! This brain is empty. Here's how to get started:",
            "steps": [
                {
                    "step": h.step,
                    "title": h.title,
