...
class StatsHandler:
        ...
        try:
            ...
            if neuron_count >= 50 and activation_pct < 20:
                ...
                hints.append(
                    ...
                    "Use smem_recall with topics you've stored to activate them "
            ...
            if brain:
                ...
                if due_count > 0:
                    hints.append(
                        ...
                        "Run smem_review action='queue' to strengthen retention."
                    )
        except Exception:
    ...
    async def _health(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        if args.get("deep", False):
            try:
                from surreal_memory.engine.gromov import estimate_gromov_delta
