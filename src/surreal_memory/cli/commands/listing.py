...
def list_memories(
    ...
    Examples:
        smem list                               # List all recent memories
        smem list --type todo                   # List all TODOs
        smem list --type decision -p 7          # High priority decisions
        smem list --expired                     # Show expired memories
        smem list --type todo --expired         # Expired TODOs (need cleanup)
        smem list --project "Q1 Sprint"         # Memories in a project
    """
...
def cleanup(
    ...
    Examples:
        smem cleanup --expired              # Remove all expired memories
        smem cleanup --expired --dry-run    # Preview what would be removed
        smem cleanup --type context         # Remove expired context memories
    """
