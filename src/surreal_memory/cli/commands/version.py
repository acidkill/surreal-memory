...
def version_callback(ctx: typer.Context) -> None:
    """Show Surreal-Memory version or manage brain versions."""
...
def version_create(
    ...
    Examples:
        smem version create v1-baseline
        smem version create pre-refactor -d "Before cleanup"
    """
...
def version_list(
    ...
    if json_output:
        ...
        if not versions:
            typer.echo("No versions found. Create one with: smem version create <name>")
            return
...
def version_diff(
    ...
    Examples:
        smem version diff abc123 def456
    """
