"""Terminal UI components for Surreal-Memory."""
...
async def render_dashboard(storage: PersistentStorage) -> None:
    ...
    from surreal_memory.safety.freshness import analyze_freshness, evaluate_freshness
    ...
    header_text.append("Surreal-Memory Dashboard", style="bold cyan")
    ...
    footer_text.append("smem ui", style="cyan")
    footer_text.append(" (browse) ", style="bright_black")
    footer_text.append("smem graph", style="cyan")
    footer_text.append(" (visualize) ", style="bright_black")
    footer_text.append("smem recall", style="cyan")
