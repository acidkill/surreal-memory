...
def create_app(
    ...
    from surreal_memory.server.dependencies import get_storage as shared_get_storage
    ...
    from surreal_memory.server.dependencies import require_local_request
    ...
    async def ui() -> Response:
        """Serve the Surreal-Memory dashboard."""
        return _serve_spa()
    ...
    async def dashboard() -> Response:
        """Serve the Surreal-Memory React dashboard."""
        return _serve_spa()
