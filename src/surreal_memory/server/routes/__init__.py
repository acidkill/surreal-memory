"""API routes for Surreal-Memory server."""

from surreal_memory.server.routes.brain import router as brain_router
from surreal_memory.server.routes.consolidation import router as consolidation_router
from surreal_memory.server.routes.dashboard_api import router as dashboard_router
from surreal_memory.server.routes.hub import router as hub_router
from surreal_memory.server.routes.integration_status import (
