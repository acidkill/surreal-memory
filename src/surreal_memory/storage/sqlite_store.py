"""SQLite storage backend — TEST FIXTURE ONLY.

v2.0.0 made SurrealDB the only production storage backend. SQLiteStorage
and its mixins remain in the tree because the unit-test suite uses them
as an in-process fixture (fast, no external service). Do not depend on
this backend for production deployments — use SurrealDB (see
...
from surreal_memory.storage.neuron_cache import NeuronLookupCache
from surreal_memory.storage.read_pool import ReadPool
...
from surreal_memory.storage.sqlite_compression import SQLiteCompressionMixin
from surreal_memory.storage.sqlite_depth_priors import SQLiteDepthPriorMixin
from surreal_memory.storage.sqlite_devices import SQLiteDevicesMixin
...
from surreal_memory.storage.sqlite_sessions import SQLiteSessionsMixin
from surreal_memory.storage.sqlite_sources import SQLiteSourcesMixin
from surreal_memory.storage.sqlite_synapses import SQLiteSynapseMixin
from surreal_memory.storage.sqlite_sync_state import SQLiteSyncStateMixin
from surreal_memory.storage.sqlite_tool_events import SQLiteToolEventsMixin
from surreal_memory.storage.sqlite_training_files import SQLiteTrainingFilesMixin
from surreal_memory.storage.sqlite_typed import SQLiteTypedMemoryMixin
from surreal_memory.storage.sqlite_versioning import SQLiteVersioningMixin
