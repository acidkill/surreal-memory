...
from surreal_memory.storage.shared_store_collections import (
    SharedFiberBrainMixin,
    SharedStorageError,
)
from surreal_memory.storage.shared_store_mappers import (
    dict_to_neuron,
...
class SharedStorage(SharedFiberBrainMixin, NeuralStorage):
    """
    HTTP-based storage client that connects to a remote Surreal-Memory server.
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            server_url: Base URL of Surreal-Memory server (e.g., "http://localhost:8000")
