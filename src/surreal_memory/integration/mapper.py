"""RecordMapper — converts ExternalRecord to Surreal-Memory neural structures."""
...
from surreal_memory.integration.models import ExternalRecord, ExternalRelationship
...
# Mapping from common external type strings to Surreal-Memory MemoryType
...
class RecordMapper:
    """Maps ExternalRecord instances to Surreal-Memory structures.
    ...
    async def map_record(self, record: ExternalRecord) -> MappingResult:
        """Map a single ExternalRecord to Surreal-Memory structures.
