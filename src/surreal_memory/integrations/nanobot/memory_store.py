"""Drop-in replacement for Nanobot's MemoryStore, backed by Surreal-Memory.
...
class NMMemoryStore:
    """Surreal-Memory-backed memory store for Nanobot.
    ...
    def list_memory_files(self) -> list[Path]:
        """Return empty list — Surreal-Memory uses SQLite, not files."""
        return []
