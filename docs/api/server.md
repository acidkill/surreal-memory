...
```bash
uvicorn surreal_memory.server:app --reload --port 8000
```
...
```json
{
  "brains_dir": "/home/user/.surrealmemory/brains",
  "brains": [
    {
      "name": "default",
      "path": "/home/user/.surrealmemory/brains/default.db",
      "size_bytes": 1048576,
      "is_active": true
    }
  ],
...
```python
from surreal_memory.server import create_app
