...
Backed by SurrealDB's multi-model engine (document + graph + vector HNSW in one database — no separate vector store). 57 MCP tools, 7800+ tests, 67%+ CI coverage, Python 3.11+, MIT.
