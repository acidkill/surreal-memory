...
(function () {
  ...
  const INIT_LINES = [
    ...
    { text: "smem init --full", cls: "cmd", typing: true },
    { text: "\n", delay: 300 },
    { text: "✓ ", cls: "ok", delay: 200 },
    { text: "Config created: ~/.surrealmemory/config.toml", delay: 0 },
    { text: "\n", delay: 150 },
    { text: "✓ ", cls: "ok", delay: 200 },
    ...
    { text: "\n", delay: 150 },
    { text: "✓ ", cls: "ok", delay: 200 },
    { text: "Embeddings: Sentence Transformers", delay: 0 },
    { text: "\n", delay: 150 },
    { text: "✓ ", cls: "ok", delay: 200 },
    ...
    { text: "\n\n", delay: 300 },
    { text: "  Surreal-Memory is ready!", cls: "accent", delay: 0 },
    { text: "\n", delay: 100 },
  ...
  const DOCTOR_LINES = [
    { text: "$ ", cls: "prompt", delay: 0 },
    { text: "smem doctor", cls: "cmd", typing: true },
    { text: "\n\n", delay: 300 },
    { text: "  Surreal-Memory Doctor\n", cls: "accent", delay: 100 },
    { text: "  ───────────────────\n\n", cls: "dim", delay: 150 },
    ...
    { text: "  [OK] ", cls: "ok", delay: 120 },
    { text: "Embedding provider   sentence_transformer\n", delay: 0 },
    { text: "  [OK] ", cls: "ok", delay: 120 },
    { text: "Schema version       v26 (current)\n", delay: 0 },
    { text: "  [OK] ", cls: "ok", delay: 120 },
    { text: "MCP configuration    surreal-memory registered\n", delay: 0 },
    { text: "  [OK] ", cls: "ok", delay: 120 },
    ...
    { text: "  [OK] ", cls: "ok", delay: 120 },
    { text: "CLI tools            smem + smem-mcp on PATH\n", delay: 0 },
    { text: "\n", delay: 200 },
