...
| `SURREAL_MEMORY_MCP_TOOL_TIMEOUT` | `src/surreal_memory/mcp/server.py` |
...
*Auto-generated by `scripts/gen_config_docs.py` from `unified_config.py` — 23 sections, 54 environment variables.*
