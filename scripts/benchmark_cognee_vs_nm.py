"""Benchmark: Cognee vs Surreal-Memory on real-world memory tasks.
...
def print_report(suite: BenchmarkSuite) -> None:
    ...
    print(f"\n{sep}")
    print("  BENCHMARK RESULTS: Surreal-Memory vs Cognee")
    print(sep)
    ...
    if not suite.cognee_available:
        ...
        if nm_wins > cognee_wins:
            print("  >> Surreal-Memory outperforms Cognee overall in this benchmark.")
        elif cognee_wins > nm_wins:
            print("  >> Cognee outperforms Surreal-Memory overall in this benchmark.")
        else:
...
def save_results(suite: BenchmarkSuite, output_path: Path) -> None:
    data = {
        "benchmark": "Surreal-Memory vs Cognee",
...
async def main() -> None:
    print("=" * 84)
    print("  Surreal-Memory vs Cognee — Real-World Memory Benchmark")
    print("=" * 84)
